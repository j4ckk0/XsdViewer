...
export const ID = {
  ...
  MENU_API: 'menuApi',
  MENU_LICENCE: 'menuLicence',
  MENU_RUNTIME: 'menuRuntime',
  ...
  API_BODY: 'apiBody',
  API_CLOSE: 'apiClose',
  LICENCE_DIALOG: 'licenceDialog',
  LICENCE_BODY: 'licenceBody',
  LICENCE_CLOSE: 'licenceClose',
  RUNTIME_DIALOG: 'runtimeDialog',
