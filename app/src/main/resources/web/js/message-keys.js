...
export const MSG = {
  ...
  API_MODEL: 'api.model',
  API_COMPARE_DECLARATIONS: 'api.compareDeclarations',
  API_COMPARE_TEXTS: 'api.compareTexts',
  API_COMPARE_SCHEMAS: 'api.compareSchemas',
  API_COMPARE_WORKSPACES: 'api.compareWorkspaces',
  API_MORE: 'api.more',
  API_REFERENCE: 'api.reference',
  API_EXAMPLES: 'api.examples',
  MENU_LICENCE: 'menu.licence',
  MENU_RUNTIME: 'menu.runtime',
  LEGAL_LICENCE_TITLE: 'legal.licence.title',
  LEGAL_LICENCE_INTRO: 'legal.licence.intro',
  LEGAL_LICENCE_FULL: 'legal.licence.full',
  LEGAL_LICENCE_FILE: 'legal.licence.file',
  LEGAL_COPYRIGHT: 'legal.copyright',
  LEGAL_RUNTIME_TITLE: 'legal.runtime.title',
  LEGAL_RUNTIME_WHAT: 'legal.runtime.what',
  LEGAL_RUNTIME_CPE: 'legal.runtime.cpe',
  LEGAL_RUNTIME_NOTICES: 'legal.runtime.notices',
  LEGAL_RUNTIME_TEMURIN: 'legal.runtime.temurin',
  LEGAL_RUNTIME_OPENJDK: 'legal.runtime.openjdk',
  ...
  MENU_PORT: 'menu.port',
  MENU_PORT_TITLE: 'menu.port.title',
  PORT_TITLE: 'port.title',
  PORT_INTRO: 'port.intro',
  PORT_LABEL: 'port.label',
  PORT_DEFAULT: 'port.default',
  HELP_SAVE: 'help.save',
  HELP_CANCEL: 'help.cancel',
  PORT_INVALID: 'port.invalid',
  SETTINGS_PORT_SET: 'settings.port.set',
  SETTINGS_PORT_CLEARED: 'settings.port.cleared',
